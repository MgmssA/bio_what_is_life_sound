...
Zusammen ergibt das `{r} max_level_points`. Diese Zahl ist größer als die Gesamtpunktanzahl ohne Multiplikatoren. Das heisst, Du kannst eine Note "Sehr gut" durchaus nur mit Aufgaben aus der Stufe III erreichen, aber diese Aufgaben sind schwieriger zu lösen. Löst Du nur Aufgaben aus Stufe I und II, so musst Du mehr lösen aber dafür sind die Aufgaben leichter. Setze nicht immer alles auf eine Karte; mische die unterschiedlichen Stufen.
...
Die Punkte pro Aufgabe entnimmst Dun der folgenden Tabelle:
